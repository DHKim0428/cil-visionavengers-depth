...
- `scripts/da3/precompute_geocalib_fov.py`
- `scripts/debug/debug_save_tilt_samples.py` with `--fov_table`
- `scripts/da3/da3_teacher_validate_tilt.py` with `geo_geocalib`
