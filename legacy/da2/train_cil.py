...
from cil_dataset import CILDepth
...
def main():
    ...
    trainset = CILDepth(args.data_dir, 'train', size=size, val_fraction=args.val_fraction)
    valset   = CILDepth(args.data_dir, 'val',   size=size, val_fraction=args.val_fraction)
